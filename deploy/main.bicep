    ...
    siteConfig: {
      appSettings: [
        ...
        }
        {
          ...
          value: storageAccount::blobService::storageAccountImagesBlobContainer
        }
      ]
    }
  }
...
output storageAccountImagesBlobContainerName string = storageAccount::blobService::storageAccountImagesBlobContainer
